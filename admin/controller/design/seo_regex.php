...
class ControllerDesignSeoRegex extends PT_Controller
{
    ...
    public function add()
    {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            $this->response->redirect($this->url->link('design/seo_regex', 'member_token=' . $this->session->data['member_token']));
        }
    ...
    protected function getList()
    {
        ...
        $data['add'] = $this->url->link('design/seo_regex/add', 'member_token=' . $this->session->data['member_token']);
        $data['delete'] = $this->url->link('design/seo_regex/delete', 'member_token=' . $this->session->data['member_token']);
        ...
        foreach ($results as $result) {
            $data['seo_regexes'][] = array(
                ...
                'edit'          => $this->url->link('design/seo_regex/edit', 'member_token=' . $this->session->data['member_token'] . '&seo_regex_id=' . $result['seo_regex_id']),
                'delete'        => $this->url->link('design/seo_regex/delete', 'member_token=' . $this->session->data['member_token'] . '&seo_regex_id=' . $result['seo_regex_id'])
            );
        }
    ...
    protected function getForm()
    {
        ...
        if (!isset($this->request->get['seo_regex_id'])) {
            $data['action'] = $this->url->link('design/seo_regex/add', 'member_token=' . $this->session->data['member_token']);
            $data['breadcrumbs'][] = array(
                'text' => $this->language->get('text_add'),
                'href' => $this->url->link('design/seo_regex/add', 'member_token=' . $this->session->data['member_token'])
            );
        } else {
            $data['action'] = $this->url->link('design/seo_regex/edit', 'member_token=' . $this->session->data['member_token'] . '&seo_regex_id=' . $this->request->get['seo_regex_id']);
            $data['breadcrumbs'][] = array(
                'text' => $this->language->get('text_edit'),
                'href' => $this->url->link('design/seo_regex/edit', 'member_token=' . $this->session->data['member_token'] . '&seo_regex_id=' . $this->request->get['seo_regex_id'])
            );
        }

        $data['cancel'] = $this->url->link('design/seo_regex', 'member_token=' . $this->session->data['member_token']);
