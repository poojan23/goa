...
class ControllerDesignSeoUrl extends PT_Controller
{
    ...
    public function add()
    {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            $this->response->redirect($this->url->link('design/seo_url', 'member_token=' . $this->session->data['member_token']));
        }
    ...
    protected function getList()
    {
        ...
        $data['add'] = $this->url->link('design/seo_url/add', 'member_token=' . $this->session->data['member_token']);
        $data['delete'] = $this->url->link('design/seo_url/delete', 'member_token=' . $this->session->data['member_token']);
        ...
        foreach ($results as $result) {
            $data['seo_urls'][] = array(
                ...
                'edit'          => $this->url->link('design/seo_url/edit', 'member_token=' . $this->session->data['member_token'] . '&seo_url_id=' . $result['seo_url_id']),
                'delete'        => $this->url->link('design/seo_url/delete', 'member_token=' . $this->session->data['member_token'] . '&seo_url_id=' . $result['seo_url_id'])
            );
        }
    ...
    protected function getForm()
    {
        ...
        if (!isset($this->request->get['seo_url_id'])) {
            $data['action'] = $this->url->link('design/seo_url/add', 'member_token=' . $this->session->data['member_token']);
            $data['breadcrumbs'][] = array(
                'text' => $this->language->get('text_add'),
                'href' => $this->url->link('design/seo_url/add', 'member_token=' . $this->session->data['member_token'])
            );
        } else {
            $data['action'] = $this->url->link('design/seo_url/edit', 'member_token=' . $this->session->data['member_token'] . '&seo_url_id=' . $this->request->get['seo_url_id']);
            $data['breadcrumbs'][] = array(
                'text' => $this->language->get('text_edit'),
                'href' => $this->url->link('design/seo_url/edit', 'member_token=' . $this->session->data['member_token'] . '&seo_url_id=' . $this->request->get['seo_url_id'])
            );
        }

        $data['cancel'] = $this->url->link('design/seo_url', 'member_token=' . $this->session->data['member_token']);
