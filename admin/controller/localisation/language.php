...
class ControllerLocalisationLanguage extends PT_Controller
{
    ...
    public function add()
    {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
            ...
            $this->response->redirect($this->url->link('localisation/language', 'member_token=' . $this->session->data['member_token']));
        }
    ...
    protected function getList()
    {
        ...
        $data['add'] = $this->url->link('localisation/language/add', 'member_token=' . $this->session->data['member_token']);
        $data['delete'] = $this->url->link('localisation/language/delete', 'member_token=' . $this->session->data['member_token']);
    ...
    protected function getForm()
    {
        ...
        if (!isset($this->request->get['language_id'])) {
            $data['action'] = $this->url->link('localisation/language/add', 'member_token=' . $this->session->data['member_token']);
            $data['breadcrumbs'][] = array(
                'text' => $this->language->get('text_add'),
                'href' => $this->url->link('localisation/language/add', 'member_token=' . $this->session->data['member_token'])
            );
        } else {
            $data['action'] = $this->url->link('localisation/language/edit', 'member_token=' . $this->session->data['member_token'] . '&language_id=' . $this->request->get['language_id']);
            $data['breadcrumbs'][] = array(
                'text' => $this->language->get('text_edit'),
                'href' => $this->url->link('localisation/language/edit', 'member_token=' . $this->session->data['member_token'])
            );
        }

        $data['cancel'] = $this->url->link('localisation/language', 'member_token=' . $this->session->data['member_token']);
