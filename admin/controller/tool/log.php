...
class ControllerToolLog extends PT_Controller
{
    private $error = array();
    ...
    public function index()
    {
        ...
        $data['download'] = $this->url->link('tool/log/download', 'member_token=' . $this->session->data['member_token']);
        $data['clear'] = $this->url->link('tool/log/clear', 'member_token=' . $this->session->data['member_token']);
    ...
    public function download()
    {
        ...
        if (file_exists($file) && filesize($file) > 0) {
            ...
            $this->response->redirect($this->url->link('tool/log', 'member_token=' . $this->session->data['member_token']));
        }
    }
